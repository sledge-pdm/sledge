...
// export class MoveToolLegacy implements ToolBehavior {
...
//     selectionManager.setAreaOffset(offset);
//     eventBus.emit('selection:offsetChanged', { newOffset: selectionManager.getAreaOffset() });
...
//     // 移動オフセットをリセット
//     selectionManager.setAreaOffset(this.startOffset);
