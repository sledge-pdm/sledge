    ...
    <>
      ...
      <div class={wikiContentRoot}>
        ...
        <div class={wikiMarkdown}>
          <h2>About</h2>
          <p>The Image Pool keeps imported images as reusable entries. Each entry is a WEBP buffer with transform info (position, scale, rotation, flip, opacity).</p>

          <h2>Add images</h2>
          <ul>
            <li><strong>From files:</strong> PNG / JPG / WEBP / GIF via the import dialog or explorer context menu.</li>
            <li><strong>From clipboard / selection:</strong> Clipboard paste or “copy to image Eadds an entry; selection export stores the bounding box.</li>
          ...
          <ul>
            <li>Select an entry to edit its transform: position (x, y), scaleX / scaleY, rotation (normalized), flipX / flipY, opacity, visibility.</li>
          ...
          <p>“Transfer to active layer Ecopies the entry pixels to the active layer using nearest-neighbor sampling, respecting transform/flip/rotation.</p>
          <ul>
