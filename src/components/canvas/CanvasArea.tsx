...
export default () => {
        ...
        wrapper.addEventListener("touchmove", (e) => {
            ...
            if (e.touches.length === 1) {
                ...
                if (xMove0 !== 0 && lastX[0] !== 0) {
                    console.log(`move X: ${xMove0} => ${metricStore.offset.x + xMove0}`)
                ...
                if (yMove0 !== 0 && lastY[0] !== 0) {
                    console.log(`move Y: ${yMove0} => ${metricStore.offset.y + yMove0}`)
                    setMetricStore("offset", {
            ...
            if (e.touches.length === 2) {
                ...
                const dist = Math.sqrt(dx * dx + dy * dy) * metricStore.zoomSensitivity;
                if (lastDist !== 0) {
                ...
                if (mutualMoveX !== 0 && lastX[0] !== 0 && lastX[1] !== 0) {
                    console.log(`move X: ${mutualMoveX} => ${metricStore.offset.x + mutualMoveX}`)
                    setMetricStore("offset", {
                ...
                if (mutualMoveY !== 0 && lastY[0] !== 0 && lastY[1] !== 0) {
                    console.log(`move Y: ${mutualMoveY} => ${metricStore.offset.y + mutualMoveY}`)
                    setMetricStore("offset", {
                        x: metricStore.offset.x,
    ...
    return (
        <div class={styles.canvas_area}>
            ...
            >
                <div ref={(el) => canvasStackRef = el} style={{
                    padding: 0,
                    margin: 0,
                }}>
                    <CanvasStack />
