...
interface LayerAddCommandContext extends CommandContext {
  createdLayer: Layer | undefined;
  layerProps: {
    name?: string;
    type?: LayerType;
    enabled?: boolean;
...
export class LayerAddCommand extends HistoryCommand {
  ...
  getContext(): LayerAddCommandContext {
    return { createdLayer: this.createdLayer, layerProps: this.layerProps };
  }
}
