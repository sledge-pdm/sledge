...
// import { canvasStore, imagePoolStore, layerListStore, projectStoreFormer, snapshotStore } from '~/stores/ProjectStores';
// import { packr } from '~/utils/msgpackr';
// import { getCurrentVersion } from '~/utils/VersionUtils';

/**
 * @deprecated dumpProject is no longer used. use getPackedCurrentProject() in save.ts.
 */
